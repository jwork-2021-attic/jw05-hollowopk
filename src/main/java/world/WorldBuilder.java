...
public class WorldBuilder {
    ...
    private WorldBuilder randomizeTiles() {
        MazeGenerator mazeGenerator = new MazeGenerator(this.width);
        mazeGenerator.generateMaze();
        int [][]maze = mazeGenerator.getMaze();
        for (int width = 0; width < this.width - 1; width+=2) {
            for (int height = 0; height < this.height - 1; height+=2) {
                Tile tile = Tile.WALL;
                ...
                tiles[width+1][height] = tile;
                tiles[width][height+1] = tile;
                tiles[width+1][height+1] = tile;
                /*
